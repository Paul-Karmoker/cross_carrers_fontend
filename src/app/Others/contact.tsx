          ...
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            <div className="p-8 md:p-16 bg-gradient-to-br from-[#2e0249] to-[#4e0581]">
              ...
              <p className="text-gray-300 mt-6 text-lg max-w-md">
                Have questions about our career services? Our team is here to help you navigate the humanitarian sector.
              </p>

              <ul className="mt-12 space-y-8">
                <ContactInfoItem 
                  href="mailto:CEO.crosscareers@gmail.com"
                  label="CEO.crosscareers@gmail.com"
                  icon={
                ...
                />
                <ContactInfoItem 
                  href="tel:+8801886795620"
                  label="+88 01886795620"
                  icon={
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
