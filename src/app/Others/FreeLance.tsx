...
const relevantCategories = ['Career Guide', 'Freelance & Remote', 'Interview Support', 'Resume / CV', "Skill Development"];
...
{relatedArticles.length > 0 && (
  <section className="bg-gray-50 py-10 lg:py-6 -my-16 ">
...
{/* FAQ Section */}
<section className="container mx-auto px-6 pb-20 mt-24">
