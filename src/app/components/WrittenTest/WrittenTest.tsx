...
const WrittenTest: React.FC = () => {
  ...
  const { data: currentQuestion, refetch: refetchQuestion } =
    useGetCurrentQuery(sessionId!, {
  ...
  const [triggerDownload, { isLoading: pdfLoading }] =
    useLazyGetPdfDownloadQuery();
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans text-slate-900">
      ...
      {step === "EXAM" && (
        <div className="sticky top-[64px] z-50 w-full bg-white/90 backdrop-blur-md border-b border-slate-200">
          <div className="max-w-5xl mx-auto px-6 py-4 flex justify-between items-center">
            <div className="flex items-center gap-6">
              ...
              <div className="h-2 w-32 bg-slate-100 rounded-full overflow-hidden border">
                <div
                  ...
                  style={{
                    width: `${(((currentQuestion?.index ?? 0) + 1) / (currentQuestion?.total ?? 5)) * 100}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div
              className={`flex items-center gap-3 px-6 py-2 rounded-2xl border-2 transition-colors ${
                localTime < 60
      ...
      <main className="flex-grow py-12 px-4">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white mt-12  border-[1px] overflow-hidden">
              <div className="p-10 bg-gradient-to-br from-emerald-500 via-teal-500 to-blue-600 text-white">
                ...
                <p className="text-slate-100 mt-2">
                  Set your parameters for the AI evaluation.
                </p>
              </div>
          ...
          {step === "READY" && (
            <div className="bg-white p-12 rounded-[.5rem] mt-16 text-center border">
              ...
              <p className="text-slate-500 mt-3 mb-8">
                You have {form.durationMinutes} minutes for this assessment.
              </p>
              <button
          ...
          {step === "EXAM" && currentQuestion && (
            <div className="space-y-6 mt-16">
              <div className="bg-white rounded-[.5rem] p-10 border">
                <h2
                  className="text-2xl font-bold text-slate-800 mb-8 select-none"
                ...
                <textarea
                  ...
                  className="w-full p-8 bg-slate-50 rounded-2xl border-1 border-indigo-500 outline-none text-lg min-h-[350px] transition-all"
                ...
                <div className="mt-8 flex justify-end">
                  <button
                    ...
                    className="bg-indigo-600 text-white px-10 py-4 rounded-xl font-bold flex items-center gap-3 disabled:opacity-50 transition-all"
                  >
          ...
          {/* STEP 4: RESULTS */}
          {step === "RESULT" && (
            <div className="bg-white rounded-[.5rem] mt-12 overflow-hidden border-1 border-emerald-600">
              ...
              <div className="p-10 flex justify-between items-center border-b">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-slate-900 text-white px-6 py-3 rounded-lg font-bold text-sm"
                >
                  <Download size={16} />{" "}
              ...
              <div className="p-10 space-y-8">
                {result?.questions.map((q, i) => (
                  <div key={i} className="bg-slate-50 p-6 rounded-2xl border">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-white p-4 rounded-xl border text-sm italic">
                        "{q.userAnswer}"
                      </div>
