...
const JobTrainingPortals: FC = () => {
  ...
  const nationalJobSites: PortalSite[] = [
    ...
    { id: 2, name: "Skill Jobs", url: "https://skill.jobs/", logo: "https://skill.jobs/images/logo-01-01-01-01.png", category: "National" },
    { id: 3, name: "MyJobs", url: "https://www.myjobs.com.bd/", logo: "https://www.myjobs.com.bd/media/front-end/img/main-logo.png", category: "National" },
    { id: 4, name: "eJobs", url: "https://www.ejobs.com.bd/", logo: "https://www.ejobs.com.bd/images/logo.png", category: "National" },
    { id: 5, name: "Teletalk", url: "https://alljobs.teletalk.com.bd/", logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRFUgbjYu-gsviQMoecCi60uUXXXF9anBrAA&s", category: "Government" },
  ...
  const internationalJobSites: PortalSite[] = [
    ...
    { id: 2, name: "Idealist", url: "https://www.idealist.org/en", logo: "https://www.idealist.org/assets/b8509b56fd9bdacd8b367a86fa5a1481ab19099f/images/logos/logo-idealist.svg", category: "International" },
  ...
  const trainingSites: PortalSite[] = [
    ...
    { id: 2, name: "Kaya", url: "https://kayaconnect.org/", logo: "https://kayaconnect.org/theme/image.php/humanitarian_academy/theme_humanitarian_academy/1731568967/logo", category: "Humanitarian" },
    { id: 3, name: "EdX", url: "https://www.edx.org/", logo: "https://www.edx.org/trademark-logos/edx-logo-elm.svg", category: "Professional" },
    { id: 4, name: "Udemy", url: "https://www.udemy.com/", logo: "https://www.udemy.com/staticx/udemy/images/v7/logo-udemy.svg", category: "Online Learning" },
  ];
      ...
      >
        ...
        <div className="p-6 flex flex-col flex-grow items-center text-center">
          ...
          <div className="h-24 w-full flex items-center justify-center bg-slate-50 rounded-xl mb-6 p-4 group-hover:bg-white transition-colors duration-300">
            <img 
              ...
              onError={(e) => { (e.currentTarget as HTMLImageElement).src = "https://via.placeholder.com/150x80?text=Portal"; }}
            />
          </div>
          ...
          <p className="text-sm text-slate-500 leading-relaxed line-clamp-2">
            Explore premium career opportunities and expert resources at {site.name}.
          </p>
        </div>
        ...
        <div className="p-6 pt-0 mt-auto">
          <a
            ...
            className="flex items-center justify-center w-full py-3 px-4 bg-slate-900 text-white text-sm font-bold rounded-xl hover:bg-blue-600 transition-all duration-300 group-hover:shadow-lg active:scale-95"
          >
            {buttonText}
  ...
  const SectionTitle = ({ children }: { children: React.ReactNode }) => (
    <div className="mb-10 text-center relative">
      <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">{children}</h2>
  ...
  if (isLoading) {
    return (
      <div className="container mx-auto px-4 py-20 grid grid-cols-1 md:grid-cols-4 gap-6">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="h-[380px] bg-slate-100 rounded-2xl animate-pulse" />
        ))}
      </div>
    );
  }
    ...
    <div className="bg-[#fcfdfe] min-h-screen py-16">
      ...
      <div className="max-w-[1420px] mx-auto px-4 space-y-24">
        ...
        <section>
          ...
          <Slider {...settings}>
            {nationalJobSites.map((site) => <Card key={site.id} site={site} buttonText="Browse Jobs" />)}
          </Slider>
        </section>
        ...
        <section>
          ...
          <Slider {...settings}>
            {internationalJobSites.map((site) => <Card key={site.id} site={site} buttonText="Explore Careers" />)}
          </Slider>
        </section>
        ...
        <section>
          ...
          <Slider {...settings}>
            {trainingSites.map((site) => <Card key={site.id} site={site} buttonText="View Courses" />)}
          </Slider>
        </section>
      </div>
    </div>
