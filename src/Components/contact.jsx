...
function Contact() {
  return (
    <>
    <Navbar/>
    <div className="mt-24 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2e0249] rounded-lg">
            <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    <h1 className="text-4xl font-bold text-white mt-2">Get in Touch</h1>
                    ...
                    <ul className="mt-12 space-y-8">
                        ...
                        <li className="flex items-center">
                            ...
                            <a href="javascript:void(0)" className="text-white text-sm ml-4">
                                5th Floor, 32/2 Rangdhonu, BBCS Lane, Senapara parbota, <br/>Mirpur-10. Dhaka. Bangladesh
                            </a>
                        </li>
                    </ul>
                    <div>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d228.14973926374682!2d90.36688567422023!3d23.80453569822507!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1740249475015!5m2!1sen!2sbd" className='w-full h-64 mt-4 rounded-md ' allowFullscreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                ...
                <div className="bg-gray-100 p-6 rounded-lg -mt-12">
                    <p className="text-4xl font-semibold text-gray-800 text-center">Request for Information</p>
