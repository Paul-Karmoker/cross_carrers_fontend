...
function contact() {
  return (
    <>
    <Navbar/>
    <div class="mt-24 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2e0249] rounded-lg">
            <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    <h1 class="text-4xl font-bold text-white mt-2">Get in Touch</h1>
                    <p class="text-sm text-gray-300 mt-4 leading-relaxed"></p>
                ...
                <div class="bg-gray-100 p-6 rounded-lg -mt-12">
                    <p class="text-4xl font-semibold text-gray-800 text-center">Request for Information</p>
